    ...
    async sendWelcomeEmail(userEmail, userName) {
        ...
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p>Тепер ви можете:</p>
                <ul>
                    <li>Створювати власні стави</li>
                    <li>Зберігати улюблені страви</li>
                    <li>Ділитися стравами з іншими</li>
                </ul>
        ...
        const textContent = `
            ...
            Тепер ви можете:
            - Створювати власні страви
            - Зберігати улюблені страви
            - Ділитися стравами з іншими
