/*
  ...
  1. New Tables
    - Ensure RLS is enabled for dish_collections and dish_collection_items
    - Add policies for proper access control

  2. Security
    - Enable RLS on dish_collections and dish_collection_items
    - Add policies for users to manage their own collections
    - Add policies for viewing public collections
*/
